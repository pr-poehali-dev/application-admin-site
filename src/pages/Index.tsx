          ...
          <Card className="bg-black/40 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-[2rem]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
              {oils.slice(0, 6).map((oil) => (
                <div key={oil.id} className="sticker-pin bg-white/95 p-6 rounded-xl space-y-4 py-[37px]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="relative flex items-center gap-4">
                  <div className="sticker-pin bg-white/95 p-8 rounded-xl flex-1 aspect-[3/2] flex flex-col items-center justify-center gap-3 my-1 py-[13px]">
